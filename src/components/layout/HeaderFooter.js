				...
				{header ? (
					<header>
						...
						<div className='header-buttons'>
							<IconButton link='/dashboard' component={CollisionLink}>
								<HomeIcon fontSize='large' />
							</IconButton>
							<IconButton link='/' component={CollisionLink}>
								<HelpIcon fontSize='large' />
							</IconButton>
						</div>
						<Navigation isDash={isDash} changeTheme={changeTheme} />
					</header>
				) : null /* footer can go here */}
			</>
		);
	}
}
